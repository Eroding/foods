...
public class BaseController {
    ...
    // String paymentUrl = "http://192.168.124.5:8089/payment/createMerchantOrder";
    // 微信支付成功 -> 支付中心 -> 天天吃货平台
    //                       |-> 回调通知的url
    //String payReturnUrl = "http://api.z.mukewang.com/foodie-dev-api/orders/notifyMerchantOrderPaid";
    String payReturnUrl = "http://www.oldman.xyz:8088/cnh-api/orders/notifyMerchantOrderPaid";
    // 用户上传头像的位置
